            ...
            textobjects = {
              select = {
                ...
                keymaps = {
                  ...
                  ["nm"] = { query = "@function.inner", desc = "Select inner part of a method/function definition" },
              ...
              swap = {
                ...
                swap_next = {
                  ...
                  ["<leader>kp"] = "@property.outer", -- swap object property with next
                  ["<leader>km"] = "@function.outer", -- swap function with next
                },
                swap_previous = {
                  ["<leader>ia"] = "@parameter.inner", -- swap parameters/argument with prev
                  ["<leader>ip"] = "@property.outer", -- swap object property with prev
                  ["<leader>im"] = "@function.outer", -- swap function with previous
                },
              },
              move = {
                enable = true,
