...
const NOTIFY_SCRIPT = '/Users/thisisxjj/.config/codex/notify.py'
const MAX_SUMMARY_CHARS = 600
const TRACKER_BIN = '/Users/thisisxjj/.config/agent-tracker/bin/tracker-client'
...
export const TrackerNotifyPlugin = async ({ client, directory, $ }) => {
  ...
  const finishTask = async (summary) => {
    ...
    await $`${TRACKER_BIN} command -summary ${
      summary || 'done'
    } finish_task`.nothrow()
  }
